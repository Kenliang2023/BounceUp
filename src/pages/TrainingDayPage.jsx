...
const TrainingDayPage = () => {
  ...
  if (!isStarted) {
    return (
      <div className="space-y-6">
        ...
        <div className="card bg-gradient-to-br from-primary to-primary-dark text-white p-5">
          <h2 className="text-xl font-bold">{trainingDay.title}</h2>
          <p className="text-white text-opacity-90 mt-2 mb-4">
            {trainingDay.description}
          </p>
  ...
  // 训练进行中，显示当前训练
  return (
    <div className="pb-24"> {/* 增加底部空间，防止内容被底部控制栏遮挡 */}
      {/* 训练进度顶部栏 */}
      <div className="sticky top-0 bg-white z-10 py-3 border-b">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2.5">
          <div 
            ...
            style={{ width: `${((currentTrainingIndex) / trainingDay.trainings.length) * 100 + 
        ...
        {currentTraining.steps && (
          <div className="mb-6">
            ...
            <div className="flex justify-between items-center mb-3">
              <div className="font-medium">第 {currentStep + 1} 步（共 {currentTraining.steps.length} 步）</div>
