    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={() => setViewMode('skills')} className="text-primary text-sm">
            查看详情
          </button>
        </div>
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={() => setViewMode('history')} className="text-primary text-sm">
            查看全部
          </button>
        </div>
              ...
              <div key={record.recordId} className="border-b pb-2 last:border-0 last:pb-0">
                ...
                <div className="mt-1 flex items-center">
                  <span className="text-xs bg-primary bg-opacity-10 text-primary rounded-full px-2 py-0.5">
                    {record.category === 'dribbling'
                      ? '运球'
                      : record.category === 'shooting'
                        ? '投篮'
                        : record.category === 'passing'
                          ? '传球'
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={() => setViewMode('calendar')} className="text-primary text-sm">
            查看完整日历
          </button>
        </div>
  ...
  const renderSkills = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setViewMode('overview')} className="text-primary">
          返回总览
        </button>
      </div>
      ...
      <div className="card">
        <div className="flex items-center mb-3">
          <span className="text-xl bg-blue-100 text-blue-600 p-2 rounded-full mr-3">🏀</span>
        ...
        <div className="bg-blue-50 rounded-lg p-3">
          ...
          <p className="text-sm text-gray-700">
            {skillProgress.dribbling < 20
              ? '初学者水平，需要继续练习基本运球技能。'
              : skillProgress.dribbling < 40
                ? '已掌握基础运球，可以尝试简单的变向。'
                : skillProgress.dribbling < 60
                  ? '运球技能进步明显，可以开始练习更复杂的控球。'
                  : skillProgress.dribbling < 80
                    ? '运球技能熟练，可以在移动中自如控球。'
      ...
      <div className="card">
        <div className="flex items-center mb-3">
          <span className="text-xl bg-red-100 text-red-600 p-2 rounded-full mr-3">🎯</span>
        ...
        <div className="bg-red-50 rounded-lg p-3">
          ...
          <p className="text-sm text-gray-700">
            {skillProgress.shooting < 20
              ? '初学者水平，需要练习正确的投篮姿势。'
              : skillProgress.shooting < 40
                ? '已掌握基础投篮姿势，准确性需要提高。'
                : skillProgress.shooting < 60
                  ? '投篮技能进步明显，可以开始练习不同距离的投篮。'
                  : skillProgress.shooting < 80
                    ? '投篮技能熟练，有较高的命中率。'
      ...
      <div className="card">
        <div className="flex items-center mb-3">
          <span className="text-xl bg-green-100 text-green-600 p-2 rounded-full mr-3">👐</span>
        ...
        <div className="bg-green-50 rounded-lg p-3">
          ...
          <p className="text-sm text-gray-700">
            {skillProgress.passing < 20
              ? '初学者水平，需要练习基本传球方式。'
              : skillProgress.passing < 40
                ? '已掌握基础传球，准确性需要提高。'
                : skillProgress.passing < 60
                  ? '传球技能进步明显，可以开始练习不同类型的传球。'
                  : skillProgress.passing < 80
                    ? '传球技能熟练，传球准确且有力。'
      ...
      <div className="card">
        <div className="flex items-center mb-3">
          <span className="text-xl bg-orange-100 text-orange-600 p-2 rounded-full mr-3">👟</span>
        ...
        <div className="bg-orange-50 rounded-lg p-3">
          ...
          <p className="text-sm text-gray-700">
            {skillProgress.movement < 20
              ? '初学者水平，需要练习基本移动步伐。'
              : skillProgress.movement < 40
                ? '已掌握基础移动，灵活性需要提高。'
                : skillProgress.movement < 60
                  ? '移动技能进步明显，可以开始练习更复杂的移动。'
                  : skillProgress.movement < 80
                    ? '移动技能熟练，移动速度和灵活性良好。'
    ...
    <div className="space-y-6">
      ...
      {trainingHistory.length > 0 ? (
        ...
        <div className="card p-6 text-center">
          ...
          <p className="text-sm text-gray-600 mt-1">完成训练后，您的记录将显示在这里</p>
