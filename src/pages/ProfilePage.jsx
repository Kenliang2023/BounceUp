  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {!isEditing && (
          <button onClick={handleEditToggle} className="btn-secondary text-sm">
            编辑资料
          </button>
        )}
      </div>
      ...
      <div className="card">
        ...
        {successMsg && (
          <div className="mb-4 p-2 bg-green-100 text-green-700 rounded text-sm">{successMsg}</div>
        )}
        ...
        {isEditing ? (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end space-x-3 pt-2">
              <button type="button" onClick={handleEditToggle} className="btn-outline">
                取消
              </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 w-full max-w-sm">
            ...
            <div className="flex justify-end space-x-3">
              <button onClick={() => setShowResetConfirm(false)} className="btn-outline">
                取消
              </button>
              <button
