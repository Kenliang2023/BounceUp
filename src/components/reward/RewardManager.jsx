    ...
    <div className="bg-white rounded-lg shadow-lg p-5 max-w-lg w-full mx-auto">
      ...
      {(isAdding || editingReward) && (
        <div className="mb-6 p-4 border rounded-lg">
          <h3 className="font-semibold mb-3">{isAdding ? '添加新奖励' : '编辑奖励'}</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">星星花费</label>
                <input
                  type="number"
                  min={1}
                  max={999}
              ...
              <div className="flex-1">
                <div className="font-medium flex items-center">
                  ...
                  {reward.priority && reward.priority !== 'medium' && (
                    <span
                      className={`ml-2 text-xs bg-${getPriorityColor(reward.priority)}-100 text-${getPriorityColor(reward.priority)}-800 rounded-full px-2 py-0.5`}
                    >
